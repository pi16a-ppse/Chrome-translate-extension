opera.isReady(
  ...
  (function() {
    ...
    /**
     *
     * @type {{no: string, sv: string, da: string}} - псевдонимы
     */
    var scandiSuffixes = {
      "da": "dk",
      "sv": "se",
    ...
    /**
     *
     * @returns {{show: show}} пересгенерированную, переведенную страницу
     * @constructor - создает кнопку перевода (да и вообще весь виджет)
     */
    ...
    /**
     * Возможные действия
     * @type {{disableLang: disableLang, blanketPreferences: blanketPreferences, resetPreferences: resetPreferences, detectLanguage: detectLanguage, setHomeLang: setHomeLang}}
     */
    var actions = {
